...
import { ArtifactToolbarItem } from '@/components/dashboard/chat/create-artifact';
      ...
      <TooltipProvider>
        <Tooltip open={!isAnimating}>
          <TooltipTrigger asChild>
            ...
            >
              {currentLevel === 2 ? <ArrowUpIcon /> : <ArrowUpIcon />}
            </motion.div>
          </TooltipTrigger>
          <TooltipContent
            side="left"
...
// 由于 useOnClickOutside 期望的是 RefObject<HTMLElement> 类型，而 toolbarRef 是 RefObject<HTMLDivElement | null> 类型，
// 这里进行类型转换以解决类型不匹配的问题。
const htmlElementRef = toolbarRef as React.RefObject<HTMLElement>;
useOnClickOutside(htmlElementRef, () => {
